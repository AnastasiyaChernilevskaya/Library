 ...
 * terms; or (ii) using the files as included with a Microsoft book subject
 * to that book's license terms. Microsoft reserves all other rights to the
...
* standard jQuery library for all bookion use.
*
