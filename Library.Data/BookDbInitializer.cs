...
namespace Library.Data
{
    public class BookDbInitializer : DropCreateDatabaseAlways<Context>
    {
        ...
        {
            db.Books.Add(new Book { Name = "Война и мир", Author = "Л. Толстой", YearOfPublishing  = 2017, Publisher = "veselka", IncludeToPage = false });
            ...
            db.Books.Add(new Book { Name = "Война и мир1", Author = "Л. Толстой1", YearOfPublishing = 2016, Publisher = "veselkas", IncludeToPage = false });
            db.Books.Add(new Book { Name = "Отцы и дети1", Author = "И. Тургенев1", YearOfPublishing = 2016, Publisher = "veselkas", IncludeToPage = false });
            db.Books.Add(new Book { Name = "Чайка1", Author = "А. Чехов1", YearOfPublishing = 2016, Publisher = "veselkas", IncludeToPage = false });
